...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%243F\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%243F\uE0B3'
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%109F▓▒░'
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%109F░▒▓'
  # The left end of left prompt.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%109F\uE0B6'
  # The right end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL='%109F\uE0B4'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%144F'  # muted beige
      local   modified='%180F'  # soft sand
      local  untracked='%250F'  # light grey
      local conflicted='%180F'  # soft sand
    else
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=144
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=180
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=180
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=180
